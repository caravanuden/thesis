...
# run from /ihome/cara/cvu_thesis
# CVU 2019

python thesis/VMZ/data/create_video_db.py \
--list_file=raiders_clips.csv \
--output_file=raiders_db \
--use_list=1 --use_video_id=1 --use_start_frame=1; \

# --gpus= \
python thesis/VMZ/tools/extract_features.py \
...
--output_path=activations/features_r2.5d_d34_l32_ft_sports1m.pkl \
